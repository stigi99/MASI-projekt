...
void ASwapWidget::setLabels(const QString &a, const QString &b, const QString &c, const QString &d, const QString &e, const QString &f ){
    labelA = a;
    labelB = e;
    labelC = f;
    verticalLabels = { ";", b, ";", c + " - ?" };
...
void ASwapWidget::paintEvent(QPaintEvent *event) {
